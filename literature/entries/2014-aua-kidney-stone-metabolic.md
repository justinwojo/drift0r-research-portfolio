...
supports:
- H-hypercalciuria-metabolic-workup
- H-hypercalciuria-bone-loss
contradicts: []
patient_overlap:
- 24h urine Ca values 283→254→333 (mg per 24h unit) (male; 2 of 3 below common 300
  (mg per day unit) threshold)
- markedly low BMD for age with high-normal CTX
...
- Population: adult kidney stone formers (not a general osteoporosis guideline).
- High-risk stone features prompting full metabolic evaluation are stone-centric (residual stones, solitary kidney, systemic disease, family history, etc.).
- Avoid extreme calcium restriction (can increase oxalate absorption and harm bone) — literature context within stone prevention.
- Single elevated 24-h Ca needs repeat confirmation and dietary context (sodium, protein, calcium intake).
...
- DOI: https://doi.org/10.1016/j.juro.2014.05.006
- PubMed: https://pubmed.ncbi.nlm.nih.gov/24857648/
- Free full text PDF (AUA): https://www.auanet.org/documents/Guidelines/PDF/Kidney-Stones-Medica-Management-Guideline-JU.pdf
